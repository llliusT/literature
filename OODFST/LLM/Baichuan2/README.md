...
```shell
hostfile=""
CUDA_VISIBLE_DEVICES=0 deepspeed --num_gpus 1 fine-tune.py  \
    --report_to "none" \
    --data_path "/home/xym/othercode/Baichuan2/fine-tune/data/belle_chat_ramdon_10k.json" \
    --model_name_or_path "/home/xym/othercode/base_model/baichuan2_base" \
    --output_dir "output" \
    --model_max_length 512 \
    --num_train_epochs 4 \
    --per_device_train_batch_size 16 \
